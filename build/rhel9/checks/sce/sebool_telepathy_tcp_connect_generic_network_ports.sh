...
expected_value="$XCCDF_VALUE_var_telepathy_tcp_connect_generic_network_ports"

check_sebool_value telepathy_tcp_connect_generic_network_ports "$expected_value"
exit $?
